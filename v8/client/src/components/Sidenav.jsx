        ...
        {navItems.map((item) => (
          <NavLink
            ...
            style={({ isActive }) => ({
              ...
              padding: "14px 24px",
              textDecoration: "none",
              color: isActive ? "#deff5f" : "#cccccc",
              backgroundColor: isActive ? "#2a2a2a" : "transparent",
              borderLeft: isActive ? "3px solid #deff5f" : "3px solid transparent",
              transition: "all 0.2s ease",
              fontWeight: isActive ? "600" : "400",
            })}
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = "#2a2a2a";
              e.currentTarget.style.color = "#deff5f";
            }}
            onMouseLeave={(e) => {
              const isActive = e.currentTarget.classList.contains("active");
              e.currentTarget.style.backgroundColor = isActive ? "#2a2a2a" : "transparent";
              e.currentTarget.style.color = isActive ? "#deff5f" : "#cccccc";
            }}
          >
