    ...
    <div className="gym-dashboard-page">
      <div className="gym-dashboard-top mb-4">
        <div className="d-flex flex-column justify-content-start gap-3">
          <div>
            <span className="badge bg-danger mb-3">Gym Membership</span>
            <h1 className="display-6 text-white mb-2">Membership Control Center</h1>
          ...
          <div className="card feature-card shadow-sm border-0">
            <div className="card-body">
              ...
              <ul className="list-unstyled text-white-75 mb-4 feature-list">
                ...
                <li>
                  <span className="badge bg-success text-white me-2">Manage</span>
                  Quick actions for member records.
                </li>
              </ul>

              <div className="plan-details mb-4">
                <h6 className="text-black mb-3">Plan details</h6>
                    ...
                    >
                      <div className="d-flex justify-content-between align-items-start mb-2">
                        <div>
                          ...
                          <div className="small text-black-50">{plan.duration} • ₹{plan.price}/month</div>
                        </div>
              ...
              <div className="d-grid gap-3">
                <Link to="/members" className="btn btn-danger btn-lg">
            ...
            <div className="col-sm-6 col-xl-3">
              <div className="card metric-card shadow-sm border-0">
                <div className="card-body text-black">
                  <div className="metric-card-title text-black">Total members</div>
                  <div className="metric-card-value">{summary.total}</div>
                  <div className="text-black-50 small">All enrolled members</div>
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-xl-3">
              <div className="card metric-card shadow-sm border-0">
                <div className="card-body text-black">
                  ...
                  <div className="text-black-50 small">Current active subscriptions</div>
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-xl-3">
              <div className="card metric-card shadow-sm border-0">
                <div className="card-body text-black">
                  ...
                  <div className="text-black-50 small">Members added this month</div>
                </div>
              </div>
            </div>
            <div className="col-sm-6 col-xl-3">
              <div className="card metric-card shadow-sm border-0">
                <div className="card-body text-black">
                  ...
                  <div className="text-black-50 small">Monthly plan revenue</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="modal-content">
                <form onSubmit={saveEdit}>
                  ...
                  <div className="modal-footer">
                    ...
                    <button type="submit" className="btn btn-danger" disabled={editSaving}>
