      ...
      >
        <div className="row align-items-center">
          ...
          <div className="col-md-3 text-center border-end border-secondary">
            ...
            <h3 className="fw-bold mt-1" style={{ color: "#deff5f" }}>
              ...
              <div
                ...
                style={{
                  ...
                  border: isCurrentPlan
                    ? `2px solid #deff5f !important`
                    : "2px solid transparent",
                  outline: isCurrentPlan ? "2px solid #deff5f" : "none",
                }}
              >
                ...
                {plan.popular && (
                  <div className="text-center mb-2">
                    <span
                      ...
                      style={{ backgroundColor: "#deff5f", color: "#1a1a1a" }}
                    >
                      ⭐ Most Popular
                    </span>
                  </div>
