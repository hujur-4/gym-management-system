  ...
  if (fetching) {
    return (
      <div className="d-flex justify-content-center align-items-center" style={{ height: "60vh" }}>
        <div className="spinner-border" style={{ color: "#deff5f" }} />
      </div>
    );
  }
    ...
    <div className="container-fluid">
      ...
      >
        <img
          ...
          style={{ width: "80px", height: "80px", objectFit: "cover", border: "3px solid #deff5f" }}
        />
        <div>
          <h4 className="fw-bold mb-1">
            Welcome back, {profile?.name?.trim() || "there"} 👋
          </h4>
          <span className="badge px-3 py-2" style={{ backgroundColor: "#deff5f", color: "#1a1a1a" }}>
            ...
            {membership ? (
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="text-center">
                  ...
                  <h3 className="fw-bold mb-0" style={{ color: "#deff5f" }}>
